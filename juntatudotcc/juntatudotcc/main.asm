...
start:
	...
	;ldi temp,0b01100100    ; OCR0A = 100 // para clk=8MHz
	out OCR0A,temp
...
;-----------------------------------
;tempo de diferença extra (fazer)  
...
;------------------------------------------
;inicio da amostragem (mudar para comando em RX)
int1_ini:
	cli
